"""
extract each xyz coordinate from .out file.
"""
...
class Output(object):
	...
	def save_trajectory(self,number):
		...
		for i in self.structure:
			...
			structure = structure + '\n'
		name = 'test'
		with open('/Users/Bo/Desktop/trajectory/xyz/'+name+'_'+str(number)+'.xyz','a') as f:
			f.write(structure)
if __name__ == '__main__':
	out = Output()
	out.load_nwoutput('/Users/Bo/Desktop/trajectory/combo4.out')
